...
async def analyze_game(req: AnalyzeRequest):
    ...
    if is_live:
        prompt = (
            ...
            "Prefer ML over spread when: the underdog ML is -120 or better AND the spread is 3 points or fewer. "
            "Prefer spread when: the favorite is -200 or worse. "
        ...
        prompt = (
            ...
            "OU_LINE: [current O/U total from your search, e.g. 228.5]\n"
            "BEST_BET: [Pick the AWAY_ML, HOME_ML, or SPREAD_LINE you wrote above — NEVER a player prop. "
            "Prefer ML over spread when: the underdog ML is -120 or better AND the spread is 3 points or fewer (small spread = small insurance, ML gives better price). "
            "Prefer spread when: the favorite is -200 or worse (spread at -110 is much better value). "
