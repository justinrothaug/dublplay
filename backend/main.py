...
async def analyze_game(req: AnalyzeRequest):
    ...
    if is_live:
        prompt = (
            ...
            "DUBL_SCORE_BET: [float 1.0-5.0 — 1.0-2.0=coin flip, 2.5-3.0=slight lean, 3.5=solid edge, "
            "4.0=strong, 4.5=very strong, 5.0=rare near-lock.]\n"
            "DUBL_REASONING_BET: [1 sentence about the EXACT bet — reference the live score situation, momentum, or specific matchup factor.]\n"
            "DUBL_SCORE_OU: [float 1.0-5.0 — same scale for O/U.]\n"
        ...
        prompt = (
            ...
            "DUBL_SCORE_BET: [float 1.0-5.0 — 1.0-2.0=coin flip, 2.5-3.0=slight lean, 3.5=solid edge, "
            "4.0=strong (clear matchup edge + supporting data), 4.5=very strong (multiple factors align), "
            "5.0=rare near-lock. Expect 2-4 picks per night at 4.0+.]\n"
            ...
            "DUBL_SCORE_OU: [float 1.0-5.0 — same scale as above for O/U.]\n"
